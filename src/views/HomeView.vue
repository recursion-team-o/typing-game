  ...
  <main>
    <div class="h-full bg-yellow-300">
      <div class="flex flex-col justify-center text-center h-1/2">
        ...
        <div>
          <a
            @click="user.saveRecord()"
            class="relative inline-flex items-center justify-center p-4 px-6 py-3 bg-white overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-lime-500 rounded-full shadow-md group cursor-pointer"
          >
            <span
            ...
            <span
              class="absolute flex items-center justify-center w-full h-full text-lime-500 transition-all duration-300 transform group-hover:translate-x-full ease"
              >テスト セーブ</span
            >
            <span class="relative invisible">Button Text</span>
          </a>
        ...
        <div>
          <a
            @click="user.getDbRecords()"
            class="relative inline-flex items-center justify-center p-4 px-6 py-3 bg-white overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-red-500 rounded-full shadow-md group cursor-pointer"
          >
            <span
